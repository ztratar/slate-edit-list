...
import getDeepestItemDepth from './getDeepestItemDepth';
import {
    PARAGRAPH,
    NESTED_LIST,
    SIMPLE_LIST,
...
describe('getDeepestItemDepth util function', () => {
    ...
    it('should return 0 if there are no list items', () => {
        ...
        expect(getDeepestItemDepth(options, editor, path)).toBe(0);
    });
    ...
    it('should return 2 for a simple list', () => {
        ...
        expect(getDeepestItemDepth(options, editor, path)).toBe(2);
    });
    ...
    it('should return 4 for a nested list', () => {
        ...
        expect(getDeepestItemDepth(options, editor, path)).toBe(4);
    });
    ...
    it('should return 1 for a list if entry path refers to a direct parent', () => {
        ...
        expect(getDeepestItemDepth(options, editor, path)).toBe(1);
    });
    ...
    it('should return 3 for a list if entry path refers to a top-most list', () => {
        ...
        expect(getDeepestItemDepth(options, editor, path)).toBe(3);
    });
